...
# Reuse a single event loop across Lambda invocations (see planner for rationale).
...
def lambda_handler(event, context):
    ...
    with observe() as observability:
        try:
            ...
            # Run the agent
            result = _run_async(run_reporter_agent(job_id, portfolio_data, user_data, db, observability))
